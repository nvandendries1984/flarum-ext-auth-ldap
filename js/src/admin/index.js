...
const settingsPrefix = 'nielsvandendries-auth-ldap.';
const translationPrefix = 'nielsvandendries-auth-ldap.admin.settings.';

app.initializers.add('nielsvandendries-auth-ldap', function(app) {
  app.extensionData
    .for('nielsvandendries-auth-ldap')
    .registerSetting(
      {
